...
> Historical proposal — superseded on14 September2026. The active [release plan](../../feedme/docs/RELEASE_PLAN.md) and [V1 scope](../../feedme/docs/V1_RELEASE_SCOPE.md) retain44 P1 features and defer only the existing10 P2/P3 features. This document's additional P1 cuts, proposed F46 paid pack and aggressive calendar were not approved and must not drive implementation or offers. F46 stays deferred; V1 monetization needs the separate U07 decision. Original proposal text below is retained for context, not release authority.
...
- The JetBrains Kotlin award additionally needs fully published Apple App Store and Google Play URLs, a description of Kotlin Multiplatform/Compose Multiplatform use, and links to publicly shared building insights. Any claimed ecosystem contribution needs its own description and public evidence. Award selection does not change the user's dual-platform goal. Rechecked14 September2026 against [official category requirements](https://revenuecat-shipaton-2026.devpost.com/rules).
