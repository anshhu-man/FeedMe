-- Exact post-copy recipient receipts and foreign source attribution inventory.
-- No shared copy, post, grant, author identity or media is erased by this addition.
