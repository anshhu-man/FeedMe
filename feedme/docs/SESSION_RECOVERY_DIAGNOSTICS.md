...
| M1.05d.5b | IN_PROGRESS | [Empty setup discard](EMPTY_SETUP_DISCARD.md) b.1, [planned credential CREATE](PLANNED_CREDENTIAL_CREATE.md) b.2a and [low-level data selection](PLANNED_STATE_ACTIVATION.md) b.2b.1 are complete bounded components; [existing-only data recovery](PLANNED_STATE_RECOVERY.md) code awaits full verification, and composite data/work journal, refresh repair and crash proof remain absent |
