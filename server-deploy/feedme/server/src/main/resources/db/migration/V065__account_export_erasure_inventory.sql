-- Exact export-job and encrypted-artifact inventory. Unrelated accounts are not held
-- merely by these known tables; the owner's export history remains a related-data hold.
-- No artifact, cloud object, shared history, or key is falsely marked physically erased.
