...
try {
  ...
  instrument('work-recovery-store', 'com.feedme.storage.AndroidSessionWorkRecoveryStoreTest', 12);
  instrument('control-recovery-store', 'com.feedme.storage.AndroidSessionControlRecoveryStoreTest', 12);
