...
/** Bounded container checks happen before ImageIO raster allocation. No URL, plugin fallback,
 * source metadata decode, or recursive EXIF traversal. Unknown coding/color forms fail closed. */
internal class PhotoContainerValidator(private val policy: PhotoProcessingPolicy) {
