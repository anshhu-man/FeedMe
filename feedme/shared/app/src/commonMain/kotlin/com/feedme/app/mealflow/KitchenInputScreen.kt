...
fun KitchenInputScreen(screen: KitchenInputPage, state: KitchenInputState,
            ...
            if (screen == KitchenInputPage.PREFERENCES) {
                ...
                (currentById.keys + draftsById.keys).forEach { id ->
                    ...
                    KitchenCard {
                        ...
                        if (current != null) TextButton(onClick = { removal = id }, enabled = !busy && !hasPending && draft == null,
    ...
    if (!unavailable && removing != null) AlertDialog(onDismissRequest = { removal = null },
        ...
        confirmButton = { TextButton(enabled = !busy, onClick = { removal = null; actions.removePantry(removing) }) { Text("Confirm pantry removal") } },
        dismissButton = { TextButton(onClick = { removal = null }) { Text("Keep pantry item") } })
}
