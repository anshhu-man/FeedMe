-- Additive local inventory only. V055/V056/V057 remain unchanged.
-- One exact new media relation fence/owner hold, and the atomic private
-- revokeSession receipt family. All shared-history/unknown-schema holds remain.
